			...
			<div class="col-md-12">
				...
				<div class="col-md-6">
					<div class="present_img">
						<img src="<?php echo base_url();?>assets/images/image-1.png" alt="image">
					</div>
				</div>
			...
			<div class="col-md-6">
				...
				<div class="col-md-6">
					<div class="features_img pull-left">
						<img src="<?php echo base_url();?>assets/images/features_img.png" alt="image">
					</div>
				</div>
			...
			<div class="col-md-12">
				...
				<div class="col-md-7">
					<div class="services_img">
						<img src="<?php echo base_url();?>assets/images/services_img1.jpg" alt="image-1">
					</div>
			...
			<div class="col-md-12">
				...
				<div class="col-md-4">
								<div class="workng_img">
									<img src="<?php echo base_url();?>assets/images/how_to_work.png" alt="image">
								</div>
				</div>
			...
			<div class="col-md-12">
				...
				<div class="section_heading">
					...
					<div class="portfolio_img">
						<div class="port_img1">
							<img src="<?php echo base_url();?>assets/images/services_img1.jpg" alt="image">
						</div>
					</div>
			...
			<div class="col-md-12">
				...
				<div class="testimonial_slide">
					<div class="testi_detail">
						<div class="testi_img">
							<img src="<?php echo base_url();?>assets/images/testi_img1.png" alt="image">
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				...
				<div class="col-md-4">
								<div class="workng_img">
									<img src="<?php echo base_url();?>assets/images/contact_img.png" alt="image">
								</div>
				</div>
