	...
	<div class="container">
    	<div class="row">
        	<div class="header_top">
        		<div class="col-md-2">
            		<div class="logo_img">
						<a href="#"><img src="<?php echo base_url();?>assets/images/logo.png" alt="logoimage"></a>
					</div>
				</div>
							...
							<div class="navbar-header">
							  ...
							  <div class="collapse navbar-collapse" id="navbar">
									...
									<ul class="nav navbar-nav">
									  ...
									  <li><a href="<?php echo base_url();?>registration" class="js-target-scroll">Drive with Yogo</a></li>
